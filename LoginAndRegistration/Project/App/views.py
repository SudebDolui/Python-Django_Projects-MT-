...
class ResendActivationCodeView(GuestOnlyView, FormView):
    template_name = 'resendActivationCode.html'
...
class RestorePasswordView(GuestOnlyView, FormView):
    template_name = 'restorePassword.html'
...
class ChangeEmailView(LoginRequiredMixin, FormView):
    template_name = 'profile/changeEmail.html'
...
class RemindUsernameView(GuestOnlyView, FormView):
    template_name = 'remindUsername.html'
...
class ChangePasswordView(BasePasswordChangeView):
    template_name = 'profile/changePassword.html'
...
class RestorePasswordConfirmView(BasePasswordResetConfirmView):
    template_name = 'restorePasswordConfirm.html'
...
class RestorePasswordDoneView(BasePasswordResetDoneView):
    template_name = 'restorePasswordDone.html'
...
class ChangeLanguageView(TemplateView):
    template_name = 'main/changeLanguage.html'
